...
function openCalendar(_obj, _mode) {
    ...
    var absoluteTop = window.pageYOffset + _obj.getBoundingClientRect().top;

    var i = 0;
    while (document.getElementsByClassName("layer_popup")[i]) {
        if (document.getElementsByClassName("layer_popup")[i].style.display == 'block') {
            div.style.left = parseInt(x + 2, 10) + "px";
            div.style.top = parseInt(absoluteTop + _obj.offsetHeight - 1, 10) + "px";
...
function showCalendar(_year, _month, _day, _stat) {
    ...
    if (document.getElementById("divCalendar")) {
        ...
        var i = 0;
        var absoluteTop = window.pageYOffset + obj.getBoundingClientRect().top;
        while (document.getElementsByClassName("layer_popup")[i]) {
            if (document.getElementsByClassName("layer_popup")[i].style.display == 'block') {
                div.style.left = parseInt(x + 2, 10) + "px";
                div.style.top = parseInt(absoluteTop + obj.offsetHeight - 1, 10) + "px";
                div.style.zIndex = 99999;
            }
            i++;
        }
